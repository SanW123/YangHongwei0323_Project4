<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStat.aspx.cs" Inherits="YangHongwei0323SkySharkWebApplication.LOB.QueryStat" %>
                            ...
                            <table>
                              ...
                              <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Logoff.aspx">Log Off</asp:HyperLink></td>
                                 ...
                                 <tr>
                                  <td></td>
                                  <td>
                                      <asp:Button ID="btnSubmit2" runat="server" Text="Submit" /></td>
                                  <td></td>
                              </tr>
                          </table>
                      </asp:WizardStep>
