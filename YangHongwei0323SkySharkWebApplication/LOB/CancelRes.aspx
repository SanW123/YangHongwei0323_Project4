<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CancelRes.aspx.cs" Inherits="YangHongwei0323SkySharkWebApplication.LOB.CancelRes" %>
                ...
                <table>
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please specify a valid ticket number" ControlToValidate="txtNo"></asp:RequiredFieldValidator></td>
                    </tr>
                     <tr>
                        <td></td>
                        <td>
